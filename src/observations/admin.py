...
class ObservingSessionAdmin(admin.ModelAdmin):
    list_display = ('user', 'datetime_start_ut', 'datetime_end_ut', 'site_name', 'slug', 'created_at', 'updated_at')
...
class StarAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('created_at', 'api_payload', 'distance_light_years', 'distance_miles')
    ordering = ('-created_at',)
...
class SpecialEventAdmin(admin.ModelAdmin):
    list_display = ('event_type', 'event_name', 'session', 'telescope_size_type', 'created_at')
